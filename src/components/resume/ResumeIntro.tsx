...
export default function ResumeIntro() {
  ...
  return (
    <section
      className="relative w-full h-[100dvh] md:h-screen flex flex-col justify-end  items-start pb-4 px-6 bg-green"
    >
      <div className="order-1 mt-36 ">
        ...
        <motion.div
          className="flex flex-col items-start justify-start leading-[1] cursor-default "
          initial={{ opacity: 0, y: 100 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{
            duration: 0.6,
        ...
        >
          <p className="font-small-variable font-neue-regular my-4 lg:my-6 leading-[1]">
        ...
        >
          <p className="font-neue-medium text-[clamp(0.7rem,1rem+4.269vw,6.25rem)] leading-[1] ">
